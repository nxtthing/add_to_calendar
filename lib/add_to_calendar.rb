    ...
    private
      ...
      def microsoft(service)
        ...
        if service == "outlook.com"
          calendar_url = "https://outlook.live.com/calendar/action/compose?path=/calendar/action/compose&rru=addevent"
        elsif service == "office365"
          calendar_url = "https://outlook.office.com/calendar/action/compose?path=/calendar/action/compose&rru=addevent"
        else
